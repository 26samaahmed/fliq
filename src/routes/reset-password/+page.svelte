...
>
	...
	<div class="flex-1 flex flex-col items-center justify-center text-center">
		<!-- Title -->
		<h1 class="text-3xl sm:text-4xl text-white font-semibold">Reset Your Password</h1>
		...
		<!-- Card -->
		<div
			class="mt-10 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 w-full max-w-md shadow-lg flex flex-col gap-5"
		>
			<!-- New Password -->
			...
			<!-- Hint -->
			<p class="text-xs text-white/60 -mt-2">Password should be at least 6 characters</p>
			...
			<!-- Back to login -->
			<a href="/login" class="text-sm text-[#DCDFF5] underline mt-2"> Back to login </a>
		</div>
	</div>
