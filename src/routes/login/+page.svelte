...
>
	...
	>
		<!-- Title -->
		<h1 class="text-3xl sm:text-4xl text-white font-semibold">Welcome Back!</h1>

		<p class="text-white/70 text-base sm:text-lg mt-3 max-w-xl">
			Enter your credentials to access your account and start creating unforgettable photo memories
			with fliq.
		</p>
		...
		<ForgotPassword open={showForgotPassword} onClose={() => (showForgotPassword = false)} />
